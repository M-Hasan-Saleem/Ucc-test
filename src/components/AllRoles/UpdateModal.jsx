...
export default function AddProduct(props) {
    ...
    const handelClick = async () => {
        if (TitleName) {
            ...
            let response = await axios.put(`${baseUrl}/role/${AdminData._id}`, data, { headers: { Authorization: `Bearer ${AdminData?.jwtToken}` } })
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-body px-sm-5 mx-50 pb-5">
                            <h1 className="text-center mb-1" id="addNewCardTitle">Update Role</h1>
