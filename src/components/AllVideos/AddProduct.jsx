                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-body px-sm-5 mx-50 pb-5">
                            <h1 className="text-center mb-1" id="addNewCardTitle">Add New Video</h1>
                            ...
                            <form encType='multipart/form-data' ref={formRef} method="POST" onSubmit={handelClick} className="row gy-1 gx-2 mt-75">
                                ...
                                <div className="col-12">
                                    <label className="form-label" htmlFor="customFile">Add Thumbnail</label>
                                    <input multiple type="file" name="thumbnail" className="form-control" id="customFile" accept="image/*" />
                                </div>
                                <div className="col-12">
                                    <label className="form-label" htmlFor="modalAddCardNumber">Add Description </label>
                                    <div className="input-group input-group-merge">
                                        <input name="description" className="form-control add-credit-card-mask" type="text" placeholder="Enter Description" />
                                ...
                                <div className="col-12">
                                    <label className="form-label" htmlFor="modalAddCardNumber">Add Tag</label>
                                    <div className="input-group input-group-merge">
                                        <select className="form-select" id="tag" name="tag">
                                            <option style={{ display: 'none' }}>Select Tag</option>
                                            {
                                                totalDBTags?.length > 0 &&
                                                totalDBTags.map((v, i) => {
                                                    return (
                                                        <option value={v?._id}>{v?.name}</option>
                                                    )
                                ...
                                <div className="col-12">
                                    ...
                                    <div className="input-group input-group-merge">
                                        <select className="form-select" id="Subscription" name="membership">
                                ...
                                <div className="col-12">
                                    <label className="form-label" htmlFor="modalAddCardNumber">Add Private Path </label>
                                    <div className="input-group input-group-merge">
                                        <input name="privatePath" className="form-control add-credit-card-mask" type="text" placeholder="Enter Description" />
                                    </div>
                                </div>
                                {/* <div className="col-12">
