...
export default function AddProduct(props) {
    ...
    const handelClick = async () => {
        if (TitleName) {
            ...
            let response = await axios.post(`${baseUrl}/merchant`, data, { headers: { Authorization: `Bearer ${AdminData?.jwtToken}` } })
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-body px-sm-5 mx-50 pb-5">
                            <h1 className="text-center mb-1" id="addNewCardTitle">Create New Merchant</h1>
                            <form enctype='multipart/form-data' className="row gy-1 gx-2 mt-75">
                                <div className="col-12">
                                    <label className="form-label" htmlFor="modalAddCardNumber">Merchant Name</label>
                                    <div className="input-group input-group-merge">
                                        <input onChange={(e) => { setProductName(e.target.value) }} value={TitleName} className="form-control add-credit-card-mask" type="text" placeholder="Enter Merchant Name" />
