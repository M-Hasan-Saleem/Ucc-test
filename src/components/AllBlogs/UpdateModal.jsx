...
export default function AddProduct(props) {
    ...
    const handelClick = async () => {
        if (TitleName && BlogSlug) {
            ...
            let response = await axios.post(`${baseUrl}/blog${AdminData?._id}`, dataForm, { headers: { Authorization: `Bearer ${AdminData?.jwtToken}` } })
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-body px-sm-5 mx-50 pb-5">
                            <h1 className="text-center mb-1" id="addNewCardTitle">Update Blog</h1>
