...
export default function AddProduct(props) {
    ...
    const handelClick = async () => {
        if (TitleName && Price) {
            ...
            let response = await axios.post(`${baseUrl}/subscription`, data, { headers: { Authorization: `Bearer ${AdminData?.jwtToken}` } })
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-body px-sm-5 mx-50 pb-5">
                            <h1 className="text-center mb-1" id="addNewCardTitle">Add New Subscription</h1>
                            <form enctype='multipart/form-data' className="row gy-1 gx-2 mt-75">
                                <div className="col-12">
                                    <label className="form-label" htmlFor="modalAddCardNumber">Subscription Name</label>
                                ...
                                <div className="col-12">
                                    <label className="form-label" htmlFor="modalAddCardNumber">Subscription Price</label>
                                    <div className="input-group input-group-merge">
                                        <input onChange={(e) => { setPrice(e.target.value) }} value={Price} className="form-control add-credit-card-mask" type="text" placeholder="Enter Subscription Price" />
