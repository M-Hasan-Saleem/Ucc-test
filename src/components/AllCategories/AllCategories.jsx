...
export default function AllCategories() {
  ...
  return (
    <div>
      ...
      <DeleteModal selectedId={tempid} selectedData={selectedData} setReload={setReload} reload={reload} />
      <UpdateModal selectedId={tempid} reload={reload} setReload={setReload} />
